const wordData = [
    {
        ...
        imi: `サツキツツジ。古名、山榴(あいつつじ)。文化的に、躑躅とは区別されることが多い。映山紅(えいさんこう)はつつじも表す。<br>普通、つつじは4月から5月に咲くが、さつきは5月から7月と開花が遅く、即ち旧暦皐月の頃に咲き揃うためこう名付けられた。<br>日本の関東から近畿を中心に自生し、屋久島にも分布する。さつきは根が水気に強く、屢々水際にも自生する。これは水気をつつじとは異なる。葉の一部は越冬葉となり、この葉は冬でも枯れることがない。<br>強い酸性の土壌を好んだりと、また過酷な環境にも強く丈夫であるため栽培や園芸によく用いられる。多くの園芸品種がある。`,
    ...
    {
        kotoba: `つつじ　躑躅　映山紅`,
        imi: `アジアに広く分布する植物で、濃い桃色、白、赤、薄紫などの花弁を持つ。<br>躑は「たちもとお-る」、躅は「ふ-む」と読み、即ちどちらも立ち止まる事を意味する漢字である。「躑躅」は「テキチョク」とも読むが、これは足踏みしたり立ち止まるという意で、つつじをこう書くのは「思わず足を止めて見てしまうほど美しい」ということに由来する、という説がある。<br>さつきとはサツキツツジのことであり、開花時期が他の躑躅よりひと月遅いことから区別して称される。しかし、躑躅と大きな見た目の違いはないため、つつじを表す漢字がさつきと読まれたり、さつきを表す漢字がつつじと読まれたりと、表記は屢々曖昧である。さつきも参照されたし。<br>ツツジ属の下位分類(ツツジの名を冠する花や冠しない近縁の花)は多く、石楠花(シャクナゲ)もツツジ属のひとつ。アザレアはセイヨウツツジのことである。<br>私達が街でよく見かける種の多くはオオムラサキツツジやヤマツツジと思われる。その美しい見た目とは裏腹に、過酷な環境に耐え、比較的手入れが容易であるため、街路樹として往来を色付けることも多い。<br>ネパールの国花。`,
    ...
    {
        kotoba: `鶍の嘴　鶍の嘴の食い違い`,
        imi: `いすかのはし<br>物事が噛み合わない、食い違うこと。<br>実際に鶍のくちばしを見られたし。`,
        gazo: [" "],
        tagu: ["鳥","故事成語･諺"],
        hiduke: "2025-09-16"
    },
