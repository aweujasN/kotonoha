const wordData = [
    {
        kotoba: `femme fatale`,
        imi: `ファムファタール。運命の女。<br>転じて男を破滅させる魔性の女という意味もある。`,
        gazo: [""],
        tagu: ["恋愛","男女","意味","フランス語"],
        hiduke: "2025-12-10"
    },
    {
        kotoba: `noblesse oblige`,
        imi: `ノブレス・オブリージュ。高貴なる者の義務。<br>「nobless」は「高貴さ」、「oblige」は「（義務を）強制する」。`,
        gazo: [""],
        tagu: ["哲学","意味","フランス語"],
        hiduke: "2025-12-10"
    },
    {
        kotoba: `ドアインザフェイス`,
        imi: ` door-in-the-face technique DITF　譲歩的要請法<br>訪問してきた説得者の顔めがけて玄関のドアを閉めるといった比喩のように、初めにより大きな要求をして敢えて断らせ(断ったことへの罪悪感、返報性の原理)、次により大きく譲歩した要求(本命の要求)をすることで、相手に要求を承諾させやすくする手法。<br>フットインザドアと組み合わせることで`,
        gazo: [""],
        tagu: ["心理学","手法"],
        hiduke: "2025-11-25"
    },
    {
        kotoba: `フットインザドア`,
        imi: `foot-in-the-door technique FITD<br>最初に相手に損失のないような小さな要求を行い、それが受け入れられてから大きな要求(本命)をし承諾しやすくさせるという、一貫性の原理を利用した手法。<br>ドアインザフェイスと組み合わせることもできる(組み合わせ方は知らない)。`,
        gazo: [""],
        tagu: ["心理学","手法"],
        hiduke: "2025-11-25"
    },
    {
        kotoba: `コニール`,
        imi: `後発ベニジピン塩酸塩　カルシウム拮抗薬　高血圧･狭心症の治療<br>代謝酵素:CYP3A4　重大な副作用:肝機能障害、黄疸<br>投与量｜tmax(h)｜t1/2（h）<br>　2mg｜1.1±0.5｜−<br>→4mg｜0.8±0.3｜1.70±0.70<br>　8mg｜0.8±0.3｜0.97±0.34`,
        gazo: [""],
        tagu: ["病","薬","飲んでる"],
        hiduke: "2025-10-29"
    },
    {
        kotoba: `モディオダール`,
        imi: `後発なし　モダフィニル　精神神経用剤(第一種向精神薬)　ナルコレプシー･特発性過眠症･CPAPを要するOASに伴う日中の過度な眠気を抑える<br>代謝酵素:CYP3A4　重大な副作用:中毒性表皮壊死融解症、皮膚粘膜眼症候群、多形紅斑･薬剤性過敏症症候群･アナフィラキシー<br>投与量｜投与日｜Tmax(h)｜T1/2(h)<br>→ 100｜７日目｜2.0±0.9 ｜12.08±3.05<br>→ 200｜７日目｜2.6±0.9 ｜12.83±1.58<br>　 300｜７日目｜2.3±1.0 ｜13.51±1.85<br>`,
        gazo: [""],
        tagu: ["病","薬","飲んでる"],
        hiduke: "2025-10-29"
    },
    {
        kotoba: `十で神童、十五で才子、二十過ぎれば只の人`,
        imi: `幼い頃は並外れた能力だと言われても成長していけば凡庸になっていく喩え。`,
        gazo: [""],
        tagu: ["故事成語･諺","年齢"],
        hiduke: "2025-10-27"
    },
    {
        kotoba: `合縁奇縁`,
        imi: `人の交わりには互いに気がよく合う合わないがあって、それは不思議な縁によるのだということ。`,
        gazo: [""],
        tagu: ["四字熟語","男女","人間関係"],
        hiduke: "2025-10-27"
    },
    {
        kotoba: `縁は異なもの味なもの`,
        imi: `男女の縁はどこでどう結ばれるかわからず、不思議でおもしろいものであるということ。`,
        gazo: [""],
        tagu: ["故事成語･諺","男女","人間関係"],
        hiduke: "2025-10-27"
    },
    {
        kotoba: `秋の鹿は笛に寄る`,
        imi: `色恋に身を滅ぼす。<br>秋が発情期である雄鹿は、雌鹿に似た笛の音に引き寄せられて人に捕らえられる。`,
        gazo: [""],
        tagu: ["故事成語･諺","男女","動物"],
        hiduke: "2025-10-27"
    },
    {
        kotoba: `女心に秋の空`,
        imi: `女の心は秋の空のようにころころ変わりやすい。<br>先出は「男心に秋の空」で江戸時代から使われていた。`,
        gazo: [""],
        tagu: ["故事成語･諺","女"],
        hiduke: "2025-10-27"
    },
    {
        kotoba: `天網恢恢疎にして漏らさず`,
        imi: `天網恢恢疎而不失(テンモウカイカイソにしてうしなわず)<br>天の網は粗いように見えて悪事を見逃すことはない。<br>老子七十三章より。`,
        gazo: [""],
        tagu: ["故事成語･諺","漢文"],
        hiduke: "2025-10-27"
    },
    {
        kotoba: `志学　而立　不惑　知命　耳順`,
        imi: `それぞれ15歳、30歳、40歳、50歳、60歳の異名。『論語』為政より。<br>孔子先生は「吾十有五にして学に志す、三十にして立つ、四十にして惑わず、50にして天命を知る、60にして耳順う、70にして心の欲する所に従えども、矩(のり：規範)を踰(こ)えず」と述べた。孔子先生でこれなら俺らはどうなっちゃうんだよ。<br><br>子曰、吾十有五而志乎学、三十而立、四十而不惑、五十而知天命、六十而耳順、七十而従心所欲不踰矩<br>`,
        gazo: [""],
        tagu: ["故事成語･諺","孔子","論語","漢文"],
        hiduke: "2025-10-27"
    },
    {
    ...
    {
        kotoba: `枝野ネロ`,
        imi: `官房長官系VOCALOID。<br>代表的なカバー曲は「炉心融解」、「メルト」。<br><br>平成23年(西暦2011年)3月11日14時46分に発生した東北地方太平洋沖地震の時、枝野幸男氏は菅直人を総理大臣とする民主党政権下で官房長官を勤めていた。この地震に伴う津波、火災、福島第一原発事故などの被害に際し、文字通り連日連夜、いつ寝ているのか分からないほど記者会見の場に立っていた。<br>「枝野寝ろ」とは、溜まっているであろう疲労をおくびにも出さず情報を発信し続けた彼に対する心配の声であり、労いの言葉である。<br>そんな彼への応援が形となったものの一つ、それがVOCALOID枝野ネロである。`,
