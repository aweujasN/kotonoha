...
const wordData = [
    {
        kotoba: "みさご",
        imi: "雎　鶚　鵃　雎鳩(ショキュウ)　魚鷹(うおたか)　Osprey<br>魚を好んで食べるタカ科の鳥。爬虫類、鳥類、貝類を食べることもある。全長54–64cm、翼開張150–180cm、体重1.2–2kg。<br>主に海岸に生息するが、湖沼や河沿など内陸部にも生息。<br>水面をゆっくりと低空飛行し、獲物を見つけると素早く翼を羽ばたかせてホバリング、急降下、水面近くで脚を伸ばし両足で獲物を捕らえる。夫婦仲が良い例えにも。<br>鷙鳥百を累ぬるも一鶚に如かず：無能な人間が沢山いても有能な人間一人には敵わない。営業会社とか将にそんな感じ。<br>（鷙鳥（シチョウ）：鷙（あらどり）。鷲や鷹などの猛鳥の総称）",
