const wordData = [
    {
        ...
        imi: `頭が黒く、嘴の黄色い小鳥。嘴で木の実をころころ転がしたり、木の実を好んで食べたところから、昔は「豆転がし」「まめうまし」などと呼ばれていた。<br>鳴き声が「いかるこきー」と聞こえるらしい。`,
        gazo: ["gazo/いか"],
        tagu: ["鳥","故事成語･諺","四字熟語"],
        hiduke: "2025-09-16"
    },
    ...
    {
        kotoba: `鷽鳩大鵬を笑う　鷽鳩笑鵬`,
        imi: `がくきゅうたいほうをわらう　がくきゅうしょうほう<br>ちっぽけなのがおっきなのを笑うこと。<br>＝燕雀安んぞ鴻鵠の志を知らんや。`,
        gazo: [""],
        tagu: ["鳥","故事成語･諺","四字熟語"],
        hiduke: "2025-09-16"
    },
