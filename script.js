const wordData = [
    {
        ...
        imi: `藁や藺草などで編まれた敷物。<br>筵と莚は冠が違う。席と蓆は冠の有無。蒟蒻の蒻はがまのめ、蒲はがま・かわやなぎ。蒲(がま)で編まれた莚を蒻蓆(ジャクセキ)。苫は茅・菅義偉（元首相、歴代最長の菅茅長官）で編んだむしろ。(植物の場合は寧ろすがよりすげが主流だろ！)。莞は藺も参照。`,
        gazo: [""],
        tagu: ["植物","漢字","物"],
        hiduke: "2025-09-12"
    },
    ...
    {
        kotoba: "みさご　雎　鶚　鵃",
        imi: "雎鳩(ショキュウ)　魚鷹(うおたか)　Osprey<br>一目惚れするくらい格好良い。白と黒とでデザインされてるのも獲物の捕え方も優雅に留まる姿も勇ましく飛ぶ姿も兎に角全てが格好良い。格好いい。<br>魚を好んで食べるタカ科の鳥。爬虫類、鳥類、貝類を食べることもある。<br>全長60cm、翼開長180cm、体重1.5kg。主に海岸に生息するが、湖沼や河沿いなど内陸部にも生息。<br>水面をゆっくりと低空飛行し、獲物を捉えると素早く翼を搏かせてホバリング、獲物目掛けて急降下、水面近くで両脚を伸ばし捕まえる。夫婦仲の良い例えにも。鴛鴦と違って大人な恋愛してると思う。<br>鷙鳥百を累ぬるも一鶚に如かず。",
